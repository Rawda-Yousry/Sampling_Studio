...
if selected =="Composer":
    ...
    if dataSet == "Loaded Signal":
        ...
        if sample:
            ...
            reconstruced,sampleTime,sampleAmp = sinc_interp(factor, frequency, time, Functions.Current_amplitude)
            changedSignal.add_trace(go.Scatter(x=time,y=reconstruced))
